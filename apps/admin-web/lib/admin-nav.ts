...
export const ADMIN_NAV_ITEMS: NavItem[] = [
  ...
  // ── 추가 메뉴 (그룹) ─────────────────────────────────────
  { name: 'DB 분배', href: '/requests/distribution', icon: Share2, groupLabel: '업무' },
...
/** /affiliate 경로용 제휴업체(affiliate=partner) 메뉴 — 내 견적/DB 관리/업체 정보 */
...
/** 모바일 하단 바로가기용 4개 — href로 참조. 항목 누락 시 해당 항목만 제외(런타임 크래시 방지) */
const MOBILE_QUICK_HREFS = ['/dashboard', '/requests', '/complaints', '/settlements'] as const;
export const MOBILE_QUICK_NAV: NavItem[] = MOBILE_QUICK_HREFS
